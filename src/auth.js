 ...
 * 
 * @returns {number: number} authUserId - unique identifier for an academic, registering with email, password and name.
 */
 ...
 * @param {string} password - User's password
 * 
 * @returns {number: number} authUserId - unique identifier for an academic, given email and password
 */
