...
describe('Test adminAuthRegister', () => {
  ...
  test('Test registering two users', () => {
    ...
    const user2 = adminAuthRegister('thomas.bordado@unsw.edu.au', 'password2', 'Thomas', 'Bordado');
...
test('adminUserDetailsUpdate return type', () => {
  clear();
  const data = adminAuthRegister('validemail@gmail.com', '1234567a', 'Jane', 'Smith');
...
test('adminUserDetailsUpdate one user', () => {
  clear();
  const id1 = adminAuthRegister('validemail@gmail.com', '1234567a', 'Jane', 'Smith');
...
test('adminUserDetailsUpdate update (more than one user)', () => {
  clear();
  const id1 = adminAuthRegister('validemail@gmail.com', '1234567a', 'Jane', 'Smith');
  const id2 = adminAuthRegister('validemail2@gmail.com', '1234567a', 'Jane', 'Smith');
...
test('adminUserPasswordUpdate return type', () => {
  clear();
  const id1 = adminAuthRegister('validemail@gmail.com', '1234567a', 'Jane', 'Smith');
  const id2 = adminAuthRegister('validemail2@gmail.com', '1234567a', 'Jennifer', 'Smith');
